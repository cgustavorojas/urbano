 ...
 */
function doActionGlobal(href, sendFiltros, msgConfirm, noMarkDouble)
{

	if (typeof noMarkDouble === "undefined") {
		noMarkDouble = false;
	}
  ...
  */
 function doActionItem(href, msgConfirm, target, targetOpts, noMarkDouble)
 {
	if (typeof noMarkDouble === "undefined") {
		noMarkDouble = false;
	}
...
<form name='grid1' id='grid1' method='POST' >
	...
	<div id='abm-query-filtros col-lg-12'>
	...
	<div id="abm-div-ajax" class="data_table">
