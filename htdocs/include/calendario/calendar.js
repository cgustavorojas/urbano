...
calendarColors['dateHoverColor'] = '#7C9BBA';
...
function getCalendar(in_dateField,in_dateField_dia,in_dateField_mes,in_dateField_anio) 
{
    ...
    calendarWindow = window.open('./include/calendario/calendar.html', 'dateSelectorPopup','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=0,dependent=no,width='+cal_width+',height='+cal_height);
